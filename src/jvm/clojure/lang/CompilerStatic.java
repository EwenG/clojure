...
public class CompilerStatic implements Opcodes{
...
//			else
      ...
      catch(Throwable e)
      {
        if(!(e instanceof CompilerException))
          throw new CompilerException(source, line, column, CompilerStatic.DEF, CompilerException.PHASE_EXECUTION, e);
        else
  ...
  public static Object macroexpand1(Object x) {
    if(x instanceof ISeq)
    {
      ...
      if(v != null)
      {
        ...
        try
        {
          ISeq args = RT.cons(form, RT.cons(CompilerStatic.LOCAL_ENV.get(), form.next()));
...
//			}
      ...
      clinitgen.invokeStatic(Type.getType(CompilerStatic.class), Method.getMethod("void pushNSandLoader(ClassLoader)"));
